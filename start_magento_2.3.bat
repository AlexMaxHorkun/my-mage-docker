...
docker run -td --name "magento-mysql" -p 23306:3306 --network "magento2-network" ogorkunad/magento-mysql-57:1.0\
...
&& docker run -td --name "magento" -p 8080:8080 -p 22222:22 --network "magento2-network" ogorkunad/magento-env-23:0.9
